...
class qtype_essay_renderer extends qtype_renderer
{
    ...
    public function feedback_files_read_only(question_attempt $qa, question_display_options $options)
    {
        ...
        foreach ($filenames as $filename) {
            ...
            if (!empty($fileurl) && !empty($filename)) {
                ...
                $annotatedfiles .= '<p><a href="' . $fileurl . '"> ' . $icon . ' Feedback_' . $filename  . '</a></p>';
            }
        }
    ...
    public function files_read_only(question_attempt $qa, question_display_options $options)
    {
        ...
        foreach ($files as $file) {
            // var_dump($this->output->pix_icon(file_file_icon($file), get_mimetype_description($file),
...
abstract class qtype_essay_format_renderer_base extends plugin_renderer_base
{
     ...
     */
    public abstract function response_area_read_only(
        $name,
        question_attempt $qa,
     ...
     */
    public abstract function response_area_input(
        $name,
        question_attempt $qa,
        question_attempt_step $step,
        $lines,
